...
\begin{flalign*}
    \symbf{L} \symbf{U} & = \begin{bmatrix}
                                1                     & 0                                      & 0                                                       \\
                                \frac{a_{21}}{u_{11}} & 1                                      & 0                                                       \\
                                \frac{a_{31}}{u_{11}} & \frac{a_{32}-\ell_{31} u_{12}}{u_{22}} & 1                                                       \\
...
\begin{flalign*}
    \symbf{L}                & = \begin{bmatrix}
                                     \sqrt{a_{11}}            & 0                                            & 0                                                                \\
                                     \frac{a_{21}}{\ell_{11}} & \sqrt{a_{22}-\ell_{21}^2}                    & 0                                                                \\
                                     \frac{a_{31}}{\ell_{11}} & \frac{a_{32}-\ell_{21} \ell_{31}}{\ell_{22}} & \sqrt{a_{33}-\ell_{31}^2-\ell_{32}^2}                            \\
                                 \end{bmatrix} & \\
